...
public class UserDaoCollectionImpl implements UserDao{
	...
	public boolean addUser(UserPojo user) {
        ...
        UserPojo newUser = new UserPojo(newId, user.getName(), user.getUsername(), user.getPassword(), user.getEmail(), user.getPhoneNumber(), user.getAddress(), user.getCaretakerPreferences());
	...
	public boolean updateUser(UserPojo user) {
		if (userData.containsKey(user.getUserId())) {
            ...
            UserPojo updatedUser = new UserPojo(user.getUserId(), user.getName(), user.getUsername(), user.getPassword(), user.getEmail(), user.getPhoneNumber(), user.getAddress(), user.getCaretakerPreferences());
