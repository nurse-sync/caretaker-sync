...
public class CaretakerPreferences {
	...
	private String forWhom; // e.g., Self, Mother, Father, Grandfather, Grandmother, wife, husband, sister,
							// bother, friend.

	public CaretakerPreferences(String category, String genderPreference, double maxHourlyRate, Date requiredFrom,
			Date requiredTo, String serviceLocation, boolean liveIn, String forWhom) {
